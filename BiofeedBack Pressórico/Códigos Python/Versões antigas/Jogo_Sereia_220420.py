...
posimax=0
posimin=0
bubble1_x=[], bubble2_x=[], bubble3_x=[], bubble1_y=[], bubble2_y=[], bubble3_y=[]
...
class plano_fundo(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
       
        #Load and Scaling of Sprites
        self.fundo = pygame.transform.scale(pygame.image.load('imagens/fund2.png'), (int(largura+10), int(altura+10)))
        self.fundo2 = pygame.transform.scale(pygame.image.load('imagens/fund1.png'), (int(largura+10), int(altura+10)))
        
        self.bolha = pygame.transform.scale(pygame.image.load('imagens/bolha_maior.png'), (int(largura/50), int(altura/30)))
        self.bolha2 = pygame.transform.scale(pygame.image.load('imagens/bolha_menor.png'), (int(largura/100), int(altura/80)))
        
        self.peixe1 = pygame.transform.scale(pygame.image.load('imagens/peixe3.png'), (int(largura/50), int(altura/30)))
        self.peixe2 = pygame.transform.scale(pygame.image.load('imagens/peixe5.png'), (int(largura/50), int(altura/30)))
        self.peixe3 = pygame.transform.scale(pygame.image.load('imagens/baleia.png'), (int(largura/3), int(altura/2)))
        self.peixe4 = pygame.transform.scale(pygame.image.load('imagens/peixe1.png'), (int(largura/50), int(altura/30)))
        self.peixe5 = pygame.transform.scale(pygame.image.load('imagens/peixe2.png'), (int(largura/50), int(altura/30)))
        self.peixe6 = pygame.transform.scale(pygame.image.load('imagens/peixe4.png'), (int(largura/50), int(altura/30)))
        self.peixe7 = pygame.transform.scale(pygame.image.load('imagens/peixe6.png'), (int(largura/50), int(altura/30)))
        self.peixe8 = pygame.transform.scale(pygame.image.load('imagens/peixe8.png'), (int(largura/50), int(altura/30)))
        self.peixe9 = pygame.transform.scale(pygame.image.load('imagens/peixe7.png'), (int(largura/50), int(altura/30)))
        self.peixe10 = pygame.transform.scale(pygame.image.load('imagens/peixe9.png'), (int(largura/50), int(altura/30)))
        
        self.cor1 = pygame.transform.scale(pygame.image.load('imagens/alga.png'), (int(largura/7), int(altura/5)))
        self.cor2 = pygame.transform.scale(pygame.image.load('imagens/concha_pausa.png'), (int(largura/8), int(altura/6)))
        self.cor3 = pygame.transform.scale(pygame.image.load('imagens/concha_musica.png'), (int(largura/8), int(altura/6)))

        #Defining Image Rectangle
        self.rect_fundo = self.fundo.get_rect() 
        
        self.rect_bolha = self.bolha.get_rect()
        self.rect_bolha2 = self.bolha2.get_rect()

        self.rect_peixe1 = self.peixe1.get_rect()
        self.rect_peixe2 = self.peixe2.get_rect()
        self.rect_peixe3 = self.peixe3.get_rect()
        self.rect_peixe4 = self.peixe4.get_rect()
        self.rect_peixe5 = self.peixe5.get_rect()
        self.rect_peixe6 = self.peixe6.get_rect()
        self.rect_peixe7 = self.peixe7.get_rect()
        self.rect_peixe8 = self.peixe8.get_rect()
        self.rect_peixe9 = self.peixe9.get_rect()
        self.rect_peixe10 = self.peixe10.get_rect()

        self.rect_cor1 = self.cor1.get_rect()
        self.rect_cor2 = self.cor2.get_rect()
        self.rect_cor3 = self.cor3.get_rect()
        ...
        for frame in range(total_frames):
            if pos_buble_y == (altura-((altura%100)%10)):
                nova, nova2 = randint(-300,300), randint(-300,300)
            if pos_buble_y < -altura*2.5:
                pos_buble_y = (altura-((altura%100)%10))+altura//70
            
            if pos_peix_x == -((altura-((altura%100)%10))//7.6):
                aleatorio = [(-400, 300), (-400, 300), (1, 5), (1, 5)]
                novapeixe, novapeixe2, escolhapeixe, escolhapeixe2 = [randint(*pair) for pair in aleatorio]
            if pos_peix_x>((altura-((altura%100)%10))//0.76):
                pos_peix_x=-((altura-((altura%100)%10))//2.53)

            bubble1_x = bubble1_x.append(pos_buble_x)
            bubble2_x = bubble2_x.append(pos_buble_x-nova2)
            bubble3_x = bubble3_x.append(pos_buble_x-nova+nova2)
            bubble1_y = bubble1_y.append(pos_buble_y)
            bubble2_y = bubble2_y.append(pos_buble_y*1.25)
            bubble3_y = bubble3_y.append(pos_buble_y*1.10)

            pos_buble_y-=5

            peixe1_x = peixe1_x.append(pos_peixe_x)
            peixe2_x = peixe1_x.append(pos_peixe_x*1.5)
            peixe3_x = peixe1_x.append(pos_peixe_x*1.10)
            peixe4_x = peixe1_x.append(pos_peixe_x*1.25)
            peixe5_x = peixe1_x.append(pos_peixe_x*1.05)
            peixe6_x = peixe1_x.append(pos_peixe_x*1.45)
            peixe7_x = peixe1_x.append(pos_peixe_x*1.15)
            peixe8_x = peixe1_x.append(pos_peixe_x*1.30)
            peixe1_y = peixe1_y.append(pos_peixe_y)
            peixe2_y = peixe2_y.append(pos_peixe_y)
            peixe3_y = peixe3_y.append(pos_peixe_y)
            peixe4_y = peixe4_y.append(pos_peixe_y)
            peixe5_y = peixe5_y.append(pos_peixe_y)
            peixe6_y = peixe6_y.append(pos_peixe_y)
            peixe7_y = peixe7_y.append(pos_peixe_y)
            peixe8_y = peixe8_y.append(pos_peixe_y)
    ...
    def show(self, tela, frame, fundo, peixe, bolha):
        if fundo==1:
            tela.blit(self.fundo, self.rect_fundo) #é preciso mandar o objeto e a área retangular
            self.rect.centerx, self.rect.centery = int(largura/2), int(altura/2)
        if fundo==2:
            tela.blit(self.fundo2, self.rect)
            self.rect.centerx, self.rect.centery = int(largura/2), int(altura/2)
...
def taragem():
   ...
   # ariel, fund, bolhas, pontos, dez, uni = sereia(), fundo(), bubble(), melhor_pont(), numeros(), numeros()
    ...
    while tara:
        ...
        cor.show(tela, posicao(35,9,"x")+largura//36, posicao(35,9,"y"), 1)
        col.show(tela, posicao(35,23,"x")+largura//36, posicao(35,23,"y"))
       # test.show(tela, 10,11, "RELAXE")
        ariel.show(tela, -100, -100, 0)
        for conta in range(0,9):
            uni.show(tela, int(largura/2), int(altura/2), conta)
            posimaxcen.show(tela, 389, 280, conta)
            posimaxdez.show(tela, 411, 280, conta)
            posimaxuni.show(tela, 433, 280, conta)
    ...
    ######### CONTRACAO TONICA
        ...
        if graf==1:
            ...
            if contagem>=0 and contagem<20:
                ...
                if pos_obs_x>=(largura-((largura%100)%10))/1.7 and pos_obs_x<=(largura-((largura%100)%10))/1.7+20: ##dist de 640 pixels entre os obstaculos
                    pos_obs_x2, pos_obs_y2 = larg, altura/2 - 0.5*altura*contagem/20

                if pos_obs_x>=(largura-((largura%100)%10))/8.5 and pos_obs_x<=(largura-((largura%100)%10))/8.5+20: ##dist de 640 pixels entre os obstaculos
                ...
                if pos_obs_x<=-(round(largura-((largura%100)%10))//2.83) and pos_obs_x>=-(round(largura-((largura%100)%10))//2.83)-20: ##dist de 640 pixels entre os obstaculos
                    pos_obs_x=larg
                    pos_obs_y=altura/2 - 0.5*altura*contagem/20
            ...
            if contagem>=20 and contagem<40:
                ...
                if pos_obs_x>=(largura-((largura%100)%10))/1.7 and pos_obs_x<=(largura-((largura%100)%10))/1.7+20: ##dist de 500 pixels entre os obstaculos
                    pos_obs_x2, pos_obs_y2 = larg, altura/2 - 0.5*altura

                if pos_obs_x>=(largura-((largura%100)%10))/8.5 and pos_obs_x<=(largura-((largura%100)%10))/8.5+20: ##dist de 500 pixels entre os obstaculos
                ...
                if pos_obs_x<=-(round(largura-((largura%100)%10))//2.83) and pos_obs_x>=-(round(largura-((largura%100)%10))//2.83)-20: ##dist de 500 pixels entre os obstaculos
                    pos_obs_x=larg
                    pos_obs_y=altura/2 - 0.5*altura


            if contagem>=40 and contagem<65:
