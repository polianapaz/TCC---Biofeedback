    ...
    ######### CONTRACAO TONICA
        ...
        if graf==1:
            ...
            if contagem>=0 and contagem<20:
                ...
                pos_obs_x-=20
##                if pos_obs_x==(largura-((largura%100)%10))/1.8: ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x2, pos_obs_y2 = larg, altura - 0.5*altura*contagem/20
##                    
##                if pos_obs_x==-((largura-((largura%100)%10))/5.8): ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x3, pos_obs_y3 = larg, altura - 0.5*altura*contagem/20
##
##                if pos_obs_x2<=(largura-((largura%100)%10))/1.8: ##dist de 500 pixels entre os obstaculos
##                    obs2.show(tela, pos_obs_x2, pos_obs_y2)
##                    pos_obs_x2-=20
##                if -((largura-((largura%100)%10))/5.8)<=pos_obs_x<(largura-((largura%100)%10))/1.8: ##dist de 500 pixels entre os obstaculos
##                    obs2.show(tela, pos_obs_x2, pos_obs_y2)
##                    pos_obs_x2-=20
##                if pos_obs_x3<=largura-((largura%100)%10)/1.8: ##dist de 500 pixels entre os obstaculos
##                    obs3.show(tela, pos_obs_x3, pos_obs_y3)
##                    pos_obs_x3-=20                    
##                if -(largura-((largura%100)%10)/1.12)<=pos_obs_x<-(largura-((largura%100)%10)/5.8): ##dist de 500 pixels entre os obstaculos
##                    obs3.show(tela, pos_obs_x3, pos_obs_y3)
##                    pos_obs_x3-=20
##
##                if pos_obs_x==-(largura-((largura%100)%10)/1.12): ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x=larg
##                    pos_obs_y=altura - 0.5*altura*contagem/20
##
                if pos_obs_x==(largura-((largura%100)%10))/1.7: ##dist de 640 pixels entre os obstaculos
                    pos_obs_x2, pos_obs_y2 = larg, altura/2 - 0.5*altura*contagem/20
                    
                if pos_obs_x==(largura-((largura%100)%10))/8.5: ##dist de 640 pixels entre os obstaculos
                ...
                if pos_obs_x==-(round(largura-((largura%100)%10))//2.83): ##dist de 640 pixels entre os obstaculos
                    pos_obs_x=larg
                    pos_obs_y=altura/2 - 0.5*altura*contagem/20
            ...
            if contagem>=20 and contagem<40:
                ...
                pos_obs_x-=20
##                if pos_obs_x==largura-((largura%100)%10)/1.8: ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x2, pos_obs_y2 = larg, altura - 0.5*altura
##                    
##                if pos_obs_x==-largura-((largura%100)%10)/5.8: ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x3, pos_obs_y3 = larg, altura - 0.5*altura
##
##                if pos_obs_x2<=largura-((largura%100)%10)/1.8: ##dist de 500 pixels entre os obstaculos
##                    obs2.show(tela, pos_obs_x2, pos_obs_y2)
##                    pos_obs_x2-=20
...
##                if pos_obs_x==-largura-((largura%100)%10)/1.12: ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x=larg
##                    pos_obs_y=altura - 0.5*altura
                
                if pos_obs_x==(largura-((largura%100)%10))/1.7: ##dist de 500 pixels entre os obstaculos
                    pos_obs_x2, pos_obs_y2 = larg, altura/2 - 0.5*altura
                    
                if pos_obs_x==(largura-((largura%100)%10))/8.5: ##dist de 500 pixels entre os obstaculos
                ...
                if pos_obs_x==-(round(largura-((largura%100)%10))//2.83): ##dist de 500 pixels entre os obstaculos
                    pos_obs_x=larg
            ...
            if contagem>=40 and contagem<65:
                ...
                pos_obs_x-=20
##                if pos_obs_x==largura-((largura%100)%10)/1.8: ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x2, pos_obs_y2 = larg, altura-0.5*altura*(1-(contagem-40)/20)
##                    
##                if pos_obs_x==-largura-((largura%100)%10)/5.8: ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x3, pos_obs_y3 = larg, altura - 0.5*altura*(1-(contagem-40)/20)
##
##                if pos_obs_x2<=largura-((largura%100)%10)/1.8: ##dist de 500 pixels entre os obstaculos
##                    obs2.show(tela, pos_obs_x2, pos_obs_y2)
##                    pos_obs_x2-=20
...
##                if pos_obs_x==-largura-((largura%100)%10)/1.12: ##dist de 500 pixels entre os obstaculos
##                    pos_obs_x=larg
##                    pos_obs_y=0.5*altura*(1-(contagem-40)/20)
