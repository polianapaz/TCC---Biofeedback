...
class numeros (pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imagemA = pygame.image.load('imagens/A.png')
        self.imagemB = pygame.image.load('imagens/B.png')
        self.imagemC = pygame.image.load('imagens/C.png')
        self.imagemD = pygame.image.load('imagens/D.png')
        self.imagemE = pygame.image.load('imagens/E.png')
        self.imagemF = pygame.image.load('imagens/F.png')
        self.imagemG = pygame.image.load('imagens/G.png')
        self.imagemH = pygame.image.load('imagens/H.png')
        self.imagemI = pygame.image.load('imagens/I.png')
        self.imagemJ = pygame.image.load('imagens/J.png')
        self.imagemK = pygame.image.load('imagens/K.png')
        self.imagemL = pygame.image.load('imagens/L.png')
        self.imagemM = pygame.image.load('imagens/M.png')
        self.imagemN = pygame.image.load('imagens/N.png')
        self.imagemO = pygame.image.load('imagens/O.png')
        self.imagemP = pygame.image.load('imagens/P.png')
        self.imagemQ = pygame.image.load('imagens/Q.png')
        self.imagemR = pygame.image.load('imagens/R.png')
        self.imagemS = pygame.image.load('imagens/S.png')
        self.imagemT = pygame.image.load('imagens/T.png')
        self.imagemU = pygame.image.load('imagens/U.png')
        self.imagemV = pygame.image.load('imagens/V.png')
        self.imagemW = pygame.image.load('imagens/W.png')
        self.imagemX = pygame.image.load('imagens/X.png')
        self.imagemY = pygame.image.load('imagens/Y.png')
        self.imagemZ = pygame.image.load('imagens/Z.png')
        ...
        self.rectA, self.rectB, self.rectC, self.rectD, self.rectE, self.rectF, self.rectG, self.rectH, self.rectI, self.rectJ, self.rectK, self.rectL,
        self.rectM, self.rectN,self.rectO, self.rectP,self.rectQ, self.rectR,self.rectS, self.rectself.rectT, self.rectU, self.rectV, self.rectW, self.rectX,
        self.rectY, self.rectI, self.rectZ = [retangulo for retangulo in let]
    ...
    def show(self, tela, pos_x, pos_y, caracter):
        ...
        if caracter=='A':
            ...
            self.rectA.centerx, self.rectA.centery = pos_x, pos_y
        if caracter=='B':
            tela.blit(self.imagemB, self.rectB)
            self.rectB.centerx, self.rectB.centery = pos_x, pos_y
        if caracter=='C':
            tela.blit(self.imagemC, self.rectC)
            self.rectC.centerx, self.rectC.centery = pos_x, pos_y
        if caracter=='D':
            tela.blit(self.imagemD, self.rectD)
            self.rectD.centerx, self.rectD.centery = pos_x, pos_y
        if caracter=='E':
            tela.blit(self.imagemE, self.rectE)
            self.rectE.centerx, self.rectE.centery = pos_x, pos_y
        if caracter=='F':
            tela.blit(self.imagemF, self.rectF)
            self.rectF.centerx, self.rectF.centery = pos_x, pos_y
        if caracter=='G':
            tela.blit(self.imagemG, self.rectG)
            self.rectG.centerx, self.rectG.centery = pos_x, pos_y
        if caracter=='H':
            tela.blit(self.imagemH, self.rectH)
            self.rectH.centerx, self.rectH.centery = pos_x, pos_y    
        if caracter=='I':
            tela.blit(self.imagemI, self.rectI)
            self.rectI.centerx, self.rectI.centery = pos_x, pos_y
        if caracter=='J':
            tela.blit(self.imagemJ, self.rectJ)
            self.rectJ.centerx, self.rectJ.centery = pos_x, pos_y
        if caracter=='K':
            tela.blit(self.imagemK, self.rectK)
            self.rectK.centerx, self.rectK.centery = pos_x, pos_y
        if caracter=='L':
            tela.blit(self.imagemL, self.rectL)
            self.rectL.centerx, self.rectL.centery = pos_x, pos_y
        if caracter=='M':
            tela.blit(self.imagemM, self.rectM)
            self.rectM.centerx, self.rectM.centery = pos_x, pos_y
        if caracter=='N':
            tela.blit(self.imagem8N, self.rectN)
            self.rectN.centerx, self.rectN.centery = pos_x, pos_y
        if caracter=='O':
            tela.blit(self.imagemO, self.rectO)
            self.rectO.centerx, self.rectO.centery = pos_x, pos_y
        if caracter=='P':
            tela.blit(self.imagemP, self.rectP)
            self.rectP.centerx, self.rectP.centery = pos_x, pos_y
        if caracter=='Q':
            tela.blit(self.imagemQ, self.rectQ)
            self.rectQ.centerx, self.rectQ.centery = pos_x, pos_y
        if caracter=='R':
            tela.blit(self.imagemR, self.rectR)
            self.rectR.centerx, self.rectR.centery = pos_x, pos_y
        if caracter=='S':
            tela.blit(self.imagemS, self.rectS)
            self.rectS.centerx, self.rectS.centery = pos_x, pos_y
        if caracter=='T':
            tela.blit(self.imagemT, self.rectT)
            self.rectT.centerx, self.rectT.centery = pos_x, pos_y
        if caracter=='U':
            tela.blit(self.imagemU, self.rectU)
            self.rectU.centerx, self.rectU.centery = pos_x, pos_y
        if caracter=='V':
            tela.blit(self.imagemV, self.rectV)
            self.rectV.centerx, self.rectV.centery = pos_x, pos_y
        if caracter=='W':
            tela.blit(self.imagemW, self.rectW)
            self.rectW.centerx, self.rectW.centery = pos_x, pos_y
        if caracter=='X':
            tela.blit(self.imagemX, self.rectX)
            self.rectX.centerx, self.rectX.centery = pos_x, pos_y
        if caracter=='Y':
            tela.blit(self.imagemY, self.rectY)
            self.rectY.centerx, self.rectY.centery = pos_x, pos_y
        if letra=='Z':
            tela.blit(self.imagemZ, self.rectZ)
            self.rectZ.centerx, self.rectZ.centery = pos_x, pos_y
...
def inicio():
    ...
    cont = [numeros()]*3 + [coluna(), coral(), sereia(), fundo(), bubble(), melhor_pont(), 700, True]
    dez, uni, letra, col, cor, ariel, fund, bolhas, pontos, pos_buble_y, menu = [i for i in cont] 
    ...
    while menu:
        ###### INTERFACE ######
        fund.show(tela, 440, 350, 1)
        for letra in "BIOFEEDBACK":
            pos_letx++
            letra.show(tela, 250+tam*pos_letx, pos_lety, letra)
        for letra in "MODO":
            letra.show(tela, 250, 650, letra) 
        for letra in "SAIR":
            letra.show(tela, 250, 750, letra)
...
##            print(lido)
        ...
        if (ser.inWaiting()>0):
            lido=int(ser.read(ser.inWaiting()))
            print(lido)
